...
#    prime_number()
    ...
    if my_choice == 1:
        ...
        print(my_choice, ' not there. Choose correct function')         
    
    """
    # Another way of using the menu-driven functionality using dictionaries
